...
from .routers import (books, characters, chat, events, notifications,
                      plan, review, sessions, settings)
...
for r in (books, chat, review, characters, events, notifications, plan,
          sessions, settings):
