...
interface AppState {
  ...
  // Pane navigation
  activePane: "explore" | "timeline" | "plan" | "review" | "status" | "characters" | "import" | "pipeline" | "quality-review" | "odv-lab" | "settings";
  setActivePane: (pane: "explore" | "timeline" | "plan" | "review" | "status" | "characters" | "import" | "pipeline" | "quality-review" | "odv-lab" | "settings") => void;
...
export const useAppStore = create<AppState>((set) => ({
  ...
  queryMode: (() => {
    ...
    const valid = ["plot_hole", "timeline", "character", "alternate"];
    return (valid.includes(m ?? "") ? m : "character") as QueryMode;
  })(),
  ...
  activePane: ((): AppState["activePane"] => {
    ...
    const valid = ["explore", "timeline", "plan", "review", "status", "characters", "import", "pipeline", "quality-review", "odv-lab", "settings"];
